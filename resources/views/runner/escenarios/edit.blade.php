...
@section('contenido')
	<div class="row">
		<div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
			<h3>Editar Escenario: {{ $escenarios -> escenario }}</h3>
			@include('alert.request')
			{!! Form::model($escenarios,['method'=>'PATCH','route'=>['runner.escenarios.update',$escenarios->id],'autocomplete'=>'off'])!!}
				{{Form::token()}}
				<div class="form-group">
					<label for="nomb_esc">Escenario:</label>
					<input type="text" class="form-control" name="escenario" value="{{ $escenarios->escenario }}">
				</div>
				<div class="form-group">
